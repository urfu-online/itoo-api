...
from itoo_api.v0.views import ProgramViewSet, ProgramCourseViewSet, \
    OrganizationCustomViewSet, OrganizationCourseViewSet, EduProjectViewSet, ProfileViewSet, EnrollProgramViewSet, CheckSessionID
...
router.register(r'check_session', CheckSessionID)
